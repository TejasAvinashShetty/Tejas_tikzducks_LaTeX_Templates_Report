...
\[\bra{b}, \ket{k}, \dyad{a}{b} \]
For more stuff like this see pdfs in 15jan18\_ latex\_term folder in Documents on mac.Much more than this is in printed form in blue packet above the cupboard and in the big aluminum box. Also refer to gratzers latex book
\[\underbrace{2} 
\]
\begin{verbatim}
a\textsuperscript{2} a\textsubscript{5}
\end{verbatim}
for a\textsuperscript{2} a\textsubscript{5}\\
